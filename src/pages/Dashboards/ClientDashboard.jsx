...
import Clientcontent from "./clientdashbord/Clientcontent";
import {
  Card,
  Typography,
  List,
...
import Assigntask from "./clientdashbord/Assigntask";
import AddEmploye from "./clientdashbord/AddEmploye";
    ...
    <div className="bg-white rounded-lg shadow-lg w-[50vw] max-w-lg">
      ...
      <div className="p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mb-2">{decodedToken.ClientRole}</p>
